...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "1": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/2vzPTkDT2DddrRoXtg25AGK55nviKXeJiG21Cu56nurg",
  },
  // BSC subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "56": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/8YGDQQgExT7zLJioLRQdcSQko1qgiCjfwVg7TBV6eR7W",
  },
  // Arbitrum subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "42161": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/7kCkjx6GK67WZrVo54UcLWZ7kBx65TogBW1CD316XZgn",
  },
};
...
function transformPoolsToTags(chainId: string, pools: Pool[]): ContractTag[] {
  ...
  return validPools.map((pool) => {
    ...
    return {
      ...
      "Project Name": "Karak",
      "UI/Website Link": "https://karak.network/",
      "Public Note": `Karak's ${pool.outputToken.symbol} (${pool.outputToken.name}) token contract.`,
    };
  });
}
